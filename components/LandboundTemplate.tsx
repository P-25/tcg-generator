...
export default function LandboundTemplate({ data, cardRef, onImageAdjust }: LandboundTemplateProps) {
  ...
  return (
    <div 
        ref={cardRef} 
        className="w-[320px] h-[480px] relative flex flex-col overflow-hidden select-none bg-black text-white rounded-2xl shadow-2xl font-serif border border-gray-800"
        style={{ 
            backgroundColor: data.customColors?.background || '#000000',
            borderColor: data.customColors?.background ? data.customColors.background : '#1f2937'
        }}
    ...
    >
      ...
      <div className="relative z-20 flex flex-col justify-end h-full p-6 pointer-events-none">
        ...
        <div className="mb-8 text-center">
            ...
            >
                {data.description || "A resilient group of adventurers who thrive in the rugged terrains of the world."}
            </p>
        </div>
